...
#if defined(NDEBUG)
# error "TGK cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "TGK Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TGK additional fees, %d delta bytes\n",
