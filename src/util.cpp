...
const char * const BITCOIN_CONF_FILENAME = "tgk.conf";
const char * const BITCOIN_PID_FILENAME = "tgk.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TGK";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TGK";
#else
    // Unix
    return pathRet / ".tgk";
#endif
