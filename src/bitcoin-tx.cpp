...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tgk-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tgk-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tgk transaction") + "\n" +
              "  tgk-tx [options] -create [commands]   " + _("Create hex-encoded tgk transaction") + "\n" +
              "\n";
