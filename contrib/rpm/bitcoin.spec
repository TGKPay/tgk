...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9823
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19822
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19823
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 9823
	%{_sbindir}/semanage port -d -p tcp 19822
	%{_sbindir}/semanage port -d -p tcp 19823
	for selinuxvariant in %{selinux_variants}; do
